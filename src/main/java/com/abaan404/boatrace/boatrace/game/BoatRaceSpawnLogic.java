...
public class BoatRaceSpawnLogic {
    ...
    public BoatRaceSpawnLogic(GameSpace gameSpace, ServerWorld world, BoatRaceMap map) {
    ...
    public void spawnPlayer(ServerPlayerEntity player) {
        ...
        if (pos == null) {
            BoatRace.LOGGER.error("Cannot spawn player! No spawn is defined in the map!");
            return;
        }
