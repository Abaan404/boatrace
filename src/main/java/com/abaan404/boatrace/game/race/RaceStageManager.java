        ...
        switch (this.goCountdown.tick(this.world)) {
            case FINISH: {
                for (ServerPlayerEntity player : this.gameSpace.getPlayers()) {
                    ...
                    this.spawnLogic.unfreezeVehicle(player);
                    player.playSoundToPlayer(SoundEvents.BLOCK_NOTE_BLOCK_PLING.value(), SoundCategory.RECORDS, 1.0f,
            ...
            case COUNTDOWN: {
                if (this.lastCountdown / 1000 != this.goCountdown.getCountdown() / 1000) {
                    this.gameSpace.getPlayers().playSound(SoundEvents.BLOCK_NOTE_BLOCK_PLING.value(), SoundCategory.RECORDS,
